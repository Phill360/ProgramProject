...
<div><?php include 'footer.php' ?></div>
  ...
  <div id="termsModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="opensans"><div class="textLarge">Use of this site and the information available on this site is subject to the following terms and conditions:</div></div>
          <div class="opensans"><div class="textLarge">1. Ownership</div></div>
          <div class="opensans"><div class="textRegular">This site (“Website”) is owned and operated by Paw Companions.</div></div>
          
          <div class="opensans"><div class="textLarge">2. Terminology</div></div>
          ...
          <div class="opensans"><div class="textLarge">3. Use of Website from outside Australia</div></div>
  ...
  use, and you are not entitled to rely on the Information. If you do so, you agree to indemnify us for any loss or damage which we may incur as a consequence.</div></div>
          ...
          <div class="opensans"><div class="textLarge">4. Acceptance of Terms and Conditions</div></div>
          <div class="opensans"><div class="textMedium">4.1</div></div><div class="opensans"><div class="textRegular">Your access and use of the Website is conditional upon your acceptance and compliance with the terms, conditions, notices and disclaimers 
  ...
  constitutes your agreement to the Terms and Conditions.</div></div>
          <div class="opensans"><div class="textMedium">4.2</div></div><div class="opensans"><div class="textRegular">We may amend the Terms and Conditions at any time by posting the amended terms and conditions on the Website. The amended terms and conditions 
  ...
  automatically terminates.</div></div>
          ...
          <div class="opensans"><div class="textLarge">5. Restrictions on Use</div></div>
  ...
  other material of any kind to this Website which contains a virus or other harmful component.</div></div>
          ...
          <div class="opensans"><div class="textLarge">6. Trade marks</div></div>
  ...
  permission, or the relevant third party contributor.</div></div>
          ...
          <div class="opensans"><div class="textLarge">7.Copyright</div></div>
  ...
  Website. Unauthorised use of the Material may violate these copyright laws.</div></div>
          ...
          <div class="opensans"><div class="textLarge">8. No Representations</div></div>
  ...
  typographical errors. The use of the Website and the Material is at your own risk. Changes are periodically made to the Website and may be made at any time.</div></div>
          ...
          <div class="opensans"><div class="textLarge">9. No Warranties</div></div>
          <div class="opensans"><div class="textMedium">9.1</div></div><div class="opensans"><div class="textRegular">The Website and Material are provided on an as is basis without any warranties of any kind. We disclaim all warranties to the fullest extent 
  permitted by law.</div></div>
          <div class="opensans"><div class="textMedium">9.2</div></div><div class="opensans"><div class="textRegular">The Trade Practices Act 1974 (Cth) and all corresponding state and territory legislation implies terms, conditions and warranties into some 
  ...
  reliance upon the Website or the Material are excluded.</div></div>
          <div class="opensans"><div class="textMedium">9.3</div></div><div class="opensans"><div class="textRegular">In addition, we do not warrant that the Website will operate error free or that this Website and its servers are free of computer viruses 
  ...
  in the need for servicing or replacing equipment or data, we are not responsible for those costs.</div></div>
          ...
          <div class="opensans"><div class="textLarge">10. Limitation of Liability</div></div>
  ...
  inability to use and access the Website and the Material.</div></div>
          ...
          <div class="opensans"><div class="textLarge">11. Specific Warnings</div></div>
  ...
  which may damage your own computer system.</div></div>
          ...
          <div class="opensans"><div class="textLarge">12. Taxes</div></div>
  ...
  Website, such charges are inclusive of any goods and services tax imposed under Australian law (“GST”).</div></div>
          ...
          <div class="opensans"><div class="textLarge">13. Internet Service Providers</div></div>
  ...
  any purpose which is unlawful or in any manner which violates any of our rights or which is prohibited by the Terms and Conditions.</div></div>
          ...
          <div class="opensans"><div class="textLarge">14. Hyperlinks</div></div>
          <div class="opensans"><div class="textMedium">14.1</div></div><div class="opensans"><div class="textRegular">The Website contains hyperlinks and other pointers to internet websites operated by third parties (“Linked Sites”). The Linked Sites are not 
  under our control and we are not responsible for the content of any Linked Site or any hyperlink contained in a Linked Site.</div></div>
          <div class="opensans"><div class="textMedium">14.2</div></div><div class="opensans"><div class="textRegular">The inclusion of any link does not imply our endorsement of the Linked Site. You link to any such Linked Site entirely at your own risk. 
  We exercise no control over the quality, safety or legality of the items advertised or sold and statements made through any Linked Sites.</div></div>
          <div class="opensans"><div class="textMedium">14.3</div></div><div class="opensans"><div class="textRegular">The Material on any Linked Site, including product information and prices, are the responsibility of the operator of the Linked Site. Any 
  ...
  including where price changes have not been reflected on the relevant site.</div></div>
          <div class="opensans"><div class="textMedium">14.4</div></div><div class="opensans"><div class="textRegular">Any purchases or dealings you have with a Linked Site are done at your own risk. We are not a party to any transaction between you and a Linked 
  ...
  this Website prevail.</div></div>
          ...
          <div class="opensans"><div class="textLarge">15. Advertisements</div></div>
          <div class="opensans"><div class="textMedium">15.1</div></div><div class="opensans"><div class="textRegular">The Website display of the Price List is an advertisement made by the Vendor Paw Companions.</div></div>
          <div class="opensans"><div class="textMedium">15.2</div></div><div class="opensans"><div class="textRegular">The Website may contain embedded hyperlinks or referral buttons to websites operated by third parties or their licensees or 
  ...
  by us.</div></div>
          ...
          <div class="opensans"><div class="textLarge">16. Disputes with Linked Sites and Advertisers</div></div>
  ...
  such disputes.</div></div>
          ...
          <div class="opensans"><div class="textLarge">17. Termination</div></div>
  ...
  liability set out in the Terms and Conditions will survive termination.</div></div>
          ...
          <div class="opensans"><div class="textLarge">18. Security of Information</div></div>
  ...
  own risk. Nevertheless, once we receive your transmission, we will take reasonable steps to preserve the security of such information.</div></div>
          ...
          <div class="opensans"><div class="textLarge">19.Indemnity Clause</div></div>
  ...
  negligent act by you in connection with the supply by a Vendor RSPCA to you of, or use by you of, any Product.</div></div>
          ...
          <div class="opensans"><div class="textLarge">20. Miscellaneous</div></div>
